    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-neutral-900 p-6 rounded-xl border border-neutral-800 shadow-sm">
          <h3 className="text-lg font-semibold text-white mb-4">Pedidos Pendentes por Mês (PC)</h3>
          <div className="h-72">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={pendingPcByMonth} margin={{ top: 20, right: 30, left: 0, bottom: 20 }}>
